import { checkIfEqual, checkIfNonEmpty, validateEmail, validateOldPassportNumber, validateOldPassportSeries, validatePassportNumber, validatePassword, validateStudIdNumber, validateStudIdSeries } from "../../../../shared/lib";
