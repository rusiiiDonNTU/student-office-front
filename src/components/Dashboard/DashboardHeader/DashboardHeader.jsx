...
import DashboardSettingsModal from "../DashboardSettingsModal/DashboardSettingsModal";
...
function DashboardHeader() {
  ...
  return (
    <header className="header">
      ...
      {showSettingsModal && <DashboardSettingsModal onClose={handleCloseSettingsModal} />}
    </header>
  );
}
